...
copyright = '2017, Pedro Rodriguez'
...
latex_documents = [
  (master_doc, 'PyFunctional.tex', 'PyFunctional Documentation',
   'Pedro Rodriguez', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyfunctional', 'PyFunctional Documentation',
     [author], 1)
]
